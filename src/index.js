...
import {validateIPaddress, getAddress, addOffset, addTileLayer} from './helpers';
...
ipInput.addEventListener('keydown', (e) => {
    if (e.key === 'Enter') {
        if (validateIPaddress(ipInput.value)) getAddress(ipInput.value).then(({data}) => setMapView(data));
    }
})
